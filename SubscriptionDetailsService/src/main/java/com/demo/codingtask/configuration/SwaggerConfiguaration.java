...
public class SwaggerConfiguaration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.demo.codingtask.controller.v1"))
	...
	private ApiInfo getApiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("demo Coding Assignment Task")
                .description("Newsletter subscription details service")
                .version("1.0.0")
                .contact(contact)
                .build();
	}
